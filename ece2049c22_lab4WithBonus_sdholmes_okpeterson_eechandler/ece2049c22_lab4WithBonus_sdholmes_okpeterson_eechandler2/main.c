...
//  {
//
//  unsigned int freq = (unsigned int) ((float) ((getScroll() - 1.0)
//      / (4095.0 - 1.0)) * (1000.0 - 100.0) + 100.0);
...
while(true)
    {
        int freq = (int) ((float) ((getScroll() - 1.0) / (4095.0 - 1.0)) * (1000.0 - 100.0)
            + 100.0);
